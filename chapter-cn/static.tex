...
\lstinline!smali!使用基于\lstinline!jasmin!\footnote{\url{http://jasmin.sourceforge.net}}\index{jasmin}的汇编语法。\lstinline!androguard!的作者Anthony Desnos为这种语法编写了UltraEdit、Notepad++和vim的语法高亮文件，可以在其博客上下载\footnote{\url{http://androguard.blogspot.com}}。
