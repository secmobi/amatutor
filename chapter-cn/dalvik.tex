...
\lstinputlisting[language=smali, firstline=5, lastline=18, firstnumber=5]{code/example-structures.smali}

\subsubsection{for结构}
\lstinputlisting[language=java, firstline=13, lastline=17, firstnumber=13]{code/example-structures.java}
\lstinputlisting[language=smali, firstline=62, lastline=97, firstnumber=62]{code/example-structures.smali}
