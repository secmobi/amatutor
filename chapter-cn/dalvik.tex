...
\subsection{常用函数结构}
下面我们再看一个代码示例，这一次对比Java和smali代码一起看。

\subsubsection{构造函数和静态成员变量}
\lstinputlisting[language=java, firstline=8, lastline=11, firstnumber=8]{code/example-structures.java}
\lstinputlisting[language={}, firstline=5, lastline=18, firstnumber=5]{code/example-structures.smali}

\subsubsection{for结构}
\lstinputlisting[language=java, firstline=13, lastline=17, firstnumber=13]{code/example-structures.java}
\lstinputlisting[language={}, firstline=62, lastline=97, firstnumber=62]{code/example-structures.smali}

\subsubsection{switch结构}
\lstinputlisting[language=java, firstline=19, lastline=29, firstnumber=19]{code/example-structures.java}
\lstinputlisting[language={}, firstline=99, lastline=158, firstnumber=99]{code/example-structures.smali}
...
\lstinputlisting[language={}, firstline=160, lastline=262, firstnumber=160]{code/example-structures.smali}

\subsubsection{数组}
\lstinputlisting[language=java, firstline=48, lastline=59, firstnumber=48]{code/example-structures.java}
\lstinputlisting[language={}, firstline=20, lastline=60, firstnumber=20]{code/example-structures.smali}
